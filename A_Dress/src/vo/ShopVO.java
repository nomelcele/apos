...
public class ShopVO {
	...
	// Valid : ¿Ã∏ß, ªÁæ˜¿⁄π¯»£, ¿Ã∏ﬁ¿œ, ∏≈¿Â¿Ã∏ß
	@NotEmpty(message = "¿Ã∏ß¿ª ¿‘∑¬«ÿ¡÷ººø‰")
	@Pattern(regexp=".*[§°-∆R]", message="«—±€∏∏ ªÁøÎ∞°¥…«’¥œ¥Ÿ")
	private String shop_master;
	//@DecimalMin(value="100000",message="")
	
	@NotEmpty(message = "ShopName¿ª ¿‘∑¬«ÿ¡÷ººø‰")
	@Pattern(regexp=".*[§°-∆R]", message="«—±€∏∏ ªÁøÎ∞°¥…«’¥œ¥Ÿ")
	private String shop_name; 
//	@Email(message = "ø√πŸ∏• ¿Ã∏ﬁ¿œ «¸Ωƒ¿Ã æ∆¥’¥œ¥Ÿ.")
	@NotEmpty(message = "¿Ã∏ﬁ¿œ¿ª ¿‘∑¬«œººø‰.")
	@Pattern(regexp="^[_0-9a-zA-Z-]+@[0-9a-zA-Z]+(.[_0-9a-zA-Z-]+)*$", message = "ø√πŸ∏• ¿Ã∏ﬁ¿œ «¸Ωƒ¿Ã æ∆¥’¥œ¥Ÿ.")
