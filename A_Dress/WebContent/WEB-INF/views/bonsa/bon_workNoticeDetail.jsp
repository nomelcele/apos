...
<!--                   <form class="form-horizontal " method="post"> -->
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-10">
                        <textarea name="" id="" class="form-control7" cols="30" rows="5" style="min-width: 350px; max-width: 700px; height:100px; margin-left: 5.7%" readonly="readonly">${v.content}</textarea>
