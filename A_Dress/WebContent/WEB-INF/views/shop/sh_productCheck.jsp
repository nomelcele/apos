...
{
 window.open(img,'popup', 'width=280, height=310, left=0, top=0, toolbar=no, location=no, directories=no, status=no, menubar=no, resizable=no, scrollbars=no, copyhistory=no');
}
...
{
 window.open(img1,'popup', 'width=280, height=100, left=0, top=0, toolbar=no, location=no, directories=no, status=no, menubar=no, resizable=no, scrollbars=no, copyhistory=no');
}
                              ...
                              <tbody>
                                 ...
                                 <c:forEach var="stList" items="${list}">
                                    <tr>
                                       ...
                                       <th><a href="javascript:open_win('upload/${stList.pro_img}')">
                                       <img src='upload/${stList.pro_img}'style="width:100px;  cursor:hand;">
                                       </a></th>
                                       <th><a href="javascript:open_win1('upload/${stList.pro_barcode}')">
                                       <img src='upload/${stList.pro_barcode}'style="width: 100px;  cursor:hand;"></a>
                                       </td>
                                       </th>
