								...
								<div class="col-lg-6">
									<form method="post" action="sh_memdetail_change" id="finishbtn">
										...
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_name" name="mem_name" minlength="2" type="text"
													value="${v.mem_name}" readonly="readonly" />
											</div>
										</div>
										<br />
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_num" name="mem_num" minlength="2" type="text"
													value="${v.mem_num }" readonly="readonly" />
											</div>
										</div>
										<br />
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_tel" name="mem_tel" minlength="2" type="text"
													value="${v.mem_tel }" readonly="readonly" />
										...
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_addr" name="mem_addr" minlength="2" type="text"
													value="${v.mem_addr }" readonly="readonly" />
											</div>
										</div>
										<br />
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_deaddr" name="mem_deaddr" minlength="2" type="text"
										...
										<div class="form-group ">
											...
											<div class="col-lg-2">
												<input class="form-control" style="width: 260px;"
													id="mem_mileage" name="mem_mileage" minlength="2"
													type="text" value="${v.mem_mileage }" readonly="readonly" />
											</div>
											<br /> <br />
										</div>
									</form>
